...
_ARCHITECT_SYSTEM = (
    ...
    "RULES:\n"
    "1. ALWAYS call memory_read first — the PM stores tech stack and user preferences there.\n"
    "2. Be fast — explore only what you need. 3-4 tool calls maximum before calling report_plan.\n"
    "3. For GREENFIELD repos (empty directory): call memory_read, then report_plan immediately.\n"
    "   Do NOT list directories or read files on an empty repo — there is nothing to read.\n"
    "   The PM's memory_read result contains everything you need: stack, platform, libraries.\n"
    "4. For EXISTING repos: list root, read 1-2 key files (package.json or pyproject.toml), then plan.\n"
    "5. Produce implementation_steps as a concrete, ordered list of actions.\n"
    "6. Call report_plan as soon as you have enough context — do not over-explore.\n"
