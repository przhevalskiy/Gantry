    ...
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
          ...
          {taskSource?.source === 'github_issues' && (
            <a
              href={`https://github.com/${taskSource.github_owner}/${taskSource.github_repo}/issues/${taskSource.github_issue_number}`}
              target="_blank"
              rel="noopener noreferrer"
              title={`GitHub Issue #${taskSource.github_issue_number}`}
              style={{
            ...
            >
              ...
              #{taskSource.github_issue_number}
            </a>
          )}
          {taskSource?.source === 'api' && (
            <span style={{
              display: 'inline-flex', alignItems: 'center', gap: '0.25rem',
              padding: '0.15rem 0.45rem',
              borderRadius: 4,
