...
Memory is exposed via the REST API:
...
Returns the facts object and the 20 most recent episodes for a project. See the **API Reference → Memory** section for the full response schema.

The **Projects** page in the UI surfaces this data directly — click the "Memory" toggle on any project card to inspect what the swarm has learned.
`,
  },
